...
<ImageRow srcs="/content/projects/scan-of-the-month/lego-ct-scan.png, /content/projects/scan-of-the-month/epipen-ct-scan.png, /content/projects/scan-of-the-month/gameboy-ct-scan.png" alts="CT scan of a Lego firefighter, CT scan of an EpiPen, CT scan of a Game Boy Color" />
...
At some point, the Financial Times reached out to collaborate on an article. The result was an [interactive FT piece on fixing broken wireless earbuds](https://ig.ft.com/fixing-my-broken-wireless-earbuds/) — using our CT scanning technology to look inside consumer electronics. That was a signal that the project had grown well beyond the engineering community.
