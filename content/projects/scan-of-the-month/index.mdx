...
I thought the best way to show them was just to show them. I started [Scan of the Month](https://scanofthemonth.com) as a simple idea: pick a few interesting objects, scan them on our Neptune CT system, and dig into the manufacturing, brand lore, and hidden engineering behind each one. No product pitch. Just genuinely interesting content about the hidden world inside everyday things.
